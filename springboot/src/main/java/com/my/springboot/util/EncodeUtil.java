...
public class EncodeUtil {
    ...
    private static String strDefaultKey = "KSM";
 
    private Cipher encryptCipher = null;
 
    private Cipher decryptCipher = null;
    
    private static EncodeUtil ecu;
    
    public static EncodeUtil getECU(){
    	if(ecu==null){
    		try {
				ecu=new EncodeUtil(strDefaultKey);
			} catch (Exception e) {
			}
    	}
    	return ecu;
     ...
     * @throws Exception
     */
    private EncodeUtil(String strKey) throws Exception {
